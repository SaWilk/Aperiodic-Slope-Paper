...
% PROOF_EEG_CF_PREP05_AFTER_ICA
% Automatic IC rejection (ICLabel) until epoching (no epoching here).
%
% Input:
...
% QA PNGs:
%   paths.checks_ica_comps_rej_dir  (rejected ICs)
%   paths.checks_ica_comps_edge_dir (edge ICs)
